...
public class EcoreAnnotationParams {
	...
	private static Stream<Arguments> ecoreConstraints() {
		return Stream.of(
			...
			arguments("Ecore", EmfaticPackage.Literals.MAP_ENTRY.getName(), 		new EcoreAnnotation(), "constraints", EmfaticPackage.Literals.MAP_ENTRY, true),
	...
	private static Stream<Arguments> ecoreDelegates(String key) {
		return Stream.of(
			...
			arguments("Ecore", EmfaticPackage.Literals.MAP_ENTRY.getName(), 		new EcoreAnnotation(), key, EmfaticPackage.Literals.MAP_ENTRY, false),
	...
	private static Stream<Arguments> emfaticMap() {
		return Stream.of(
				...
				arguments("Emfatic", EmfaticPackage.Literals.MAP_ENTRY.getName(), 		new EmfaticMapAnnotation(), "any", EmfaticPackage.Literals.MAP_ENTRY, false),
	...
	private static Stream<Arguments> genModelAll(String key) {
		return Stream.of(
				...
				arguments("GenModel", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new GenModelAnnotation(), key, EmfaticPackage.Literals.MAP_ENTRY, true),
	...
	private static Stream<Arguments> genModelFeatures(String key) {
		return Stream.of(
				...
				arguments("GenModel", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new GenModelAnnotation(), key, EmfaticPackage.Literals.MAP_ENTRY, false),
				arguments("GenModel", EmfaticPackage.Literals.ATTRIBUTE.getName(), 			new GenModelAnnotation(), key, EmfaticPackage.Literals.ATTRIBUTE, true),
				arguments("GenModel", EmfaticPackage.Literals.REFERENCE.getName(),			new GenModelAnnotation(), key, EmfaticPackage.Literals.REFERENCE, true),
	...
	private static Stream<Arguments> metaDataNamespace() {
		return Stream.of(
				...
				arguments("ExtendedMetaData", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new MetaDataAnnotation(), "Namespace", EmfaticPackage.Literals.MAP_ENTRY, false),
	...
	private static Stream<Arguments> metaDataQualified() {
		return Stream.of(
				...
				arguments("ExtendedMetaData", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new MetaDataAnnotation(), "Qualified", EmfaticPackage.Literals.MAP_ENTRY, false),
	...
	private static Stream<Arguments> metaDataName() {
		return Stream.of(
				...
				arguments("ExtendedMetaData", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new MetaDataAnnotation(), "Name", EmfaticPackage.Literals.MAP_ENTRY, false),
	...
	private static Stream<Arguments> metaDataFeatures(String key) {
		return Stream.of(
				...
				arguments("ExtendedMetaData", EmfaticPackage.Literals.MAP_ENTRY.getName(), 			new MetaDataAnnotation(), key, EmfaticPackage.Literals.MAP_ENTRY, false),
